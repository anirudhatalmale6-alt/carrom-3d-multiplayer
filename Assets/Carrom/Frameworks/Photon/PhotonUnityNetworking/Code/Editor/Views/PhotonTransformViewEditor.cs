...
namespace Photon.Pun
{
    ...
    public class PhotonTransformViewEditor : Editor
    {
        ...
        SerializedProperty pos, rot, scl, lcl, inversePosition, inverseRotation;
        ...
        public void OnEnable()
        {
            ...
            inversePosition = serializedObject.FindProperty("inversePosition");
            inverseRotation = serializedObject.FindProperty("inverseRotation");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                EditorGUILayout.BeginVertical("HelpBox");
                {
                    ...
                    EditorGUILayout.PropertyField(inversePosition, new GUIContent("Inverse Position", inversePosition.tooltip));
                    EditorGUILayout.PropertyField(inverseRotation, new GUIContent("Inverse Rotation", inverseRotation.tooltip));
                }
